...
We can do it with handling the disconnection event. If one user is disconnected and you got the event, make the value of the ChatRoom.Participant.status = OFFLINE with 10 minutes TTL.
